...
trait ParamPullApi extends ParamPullExp { self: RosApi =>

}

trait ParamPullExp { self: RosExp =>
  ...
  case class ParamPull(s: Exp[ParamPull]) extends MetaAny[ParamPull] {
    ...
    @api def response: ParamPullRep =
      ParamPullRep(stage(ParamPullReply(s))(ctx))
  ...
  case class ParamPullRep(s: Exp[ParamPullRep]) extends MetaAny[ParamPullRep] {
    ...
    @api def param_received: FixPt[FALSE, _32, _0] =
      FixPt(stage(ParamPullRep_reply_param_received(s))(ctx))
  ...
  case class ParamPullRep_reply_success(srv: Exp[ParamPullRep])
      extends Op[Bool] {
    def mirror(f: Tx) = stage(ParamPullRep_reply_success(f(srv)))(EmptyContext)
  }

  case class ParamPullRep_reply_param_received(srv: Exp[ParamPullRep])
      extends Op[FixPt[FALSE, _32, _0]] {
    def mirror(f: Tx) =
      stage(ParamPullRep_reply_param_received(f(srv)))(EmptyContext)
  }
  ...
  object ParamPull {
    ...
    @api def apply(force_pull: Bool): ParamPull =
      ParamPull(stage(NewParamPull(force_pull.s))(ctx))
  }
