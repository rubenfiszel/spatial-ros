...
trait PointApi extends PointExp { self: RosApi =>

}

trait PointExp { self: RosExp =>
  ...
  case class NewPoint(x: Exp[FltPt[_53, _11]],
                      y: Exp[FltPt[_53, _11]],
                      z: Exp[FltPt[_53, _11]])
      extends Op[Point] {
  ...
  object Point {
    ...
    def apply(x: FltPt[_53, _11],
              y: FltPt[_53, _11],
              z: FltPt[_53, _11]): Point =
      Point(stage(NewPoint(x.s, y.s, z.s))(ctx))
