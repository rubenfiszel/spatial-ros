...
import spatial.ros.codegen.scalagen.{RosGenScalaRosStatic, RosScalaCodegen, RosScalaFileGen}
...
trait RosGen extends RosCodegen with RosFileGen
  ...
  with CppGenHashMap with CppGenStructs with CppGenDebugging with CppGenFileIO with RosGenRosStatic {
    override val IR: RosCompiler

}

trait RosGenScala extends RosScalaCodegen with RosScalaFileGen
  ...
  with ScalaGenMavros with RosGenScalaRosStatic {
